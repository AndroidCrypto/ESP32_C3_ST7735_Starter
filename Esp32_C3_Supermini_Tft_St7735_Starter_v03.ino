/*
  ...
  - the Supermini Plus board has an antenna interface and a RGB LED instead of blue LED *2)

  Purpose of the sketch:
  - print data on the TFT display in different colors and sizes
  - get system informations about the ESP32 chip on the board
  - *1) uses the onboard (blue) led 
  - 2*) uses the onboard RGB led 
...
/*
Version Management
26.04.2025 V03 includes code for ESP32-C3 Supermini Plus
26.04.2025 V02 just description changing
